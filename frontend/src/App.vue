<template>
    <Bienvenidos v-if="panels[0]" @nuevoPacienteRoute="() => togglePanel(1)" @editarPacienteRoute="() => togglePanel(2)" @consultarPacienteRoute="() => togglePanel(3)" />
...
const panels = ref([true, false, false, false, false, false, false])
